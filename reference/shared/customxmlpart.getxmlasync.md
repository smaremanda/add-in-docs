...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Access to a  **string** that contains the XML of the referenced [CustomXmlPart](../../reference/shared/customxmlnode.getnodesasync.md) object.|
