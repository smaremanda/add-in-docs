...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Access an  **array** of [CustomXMLPart](../../reference/shared/customxmlnode.getnodesasync.md) objects that match the specified namespace.|
