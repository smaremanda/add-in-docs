...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Access an  **array** of [CustomXMLNode](../../reference/shared/customxmlnode.customxmlnode.md) objects that represent the nodes specified by the XPath expression passed to the _xPath_ parameter.|
