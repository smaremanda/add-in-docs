...
####  convertToLocalClientTime(timeValue) → {[LocalClientTime](simple-types.html#LocalClientTime)}
...
<dd>[LocalClientTime](simple-types.html#LocalClientTime)</dd>
...
|Name| Type| Description|
|---|---|---|
|`input`| [LocalClientTime](simple-types.html#LocalClientTime)|The local time value to convert.|
