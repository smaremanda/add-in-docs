...
|---|---|---|---|
|`recipients`| Array.&lt;(String&#124;[EmailUser](simple-types.html#EmailUser)&#124;[EmailAddressDetails](simple-types.html#EmailAddressDetails))&gt;||The recipients to add to the recipients list.|
...
When the call completes, the `asyncResult.value` property will contain an array of [`EmailAddressDetails`](simple-types.html#EmailAddressDetails) objects.|
