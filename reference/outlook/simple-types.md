...
|`status`| [Office.AsyncResultStatus](Office.html#.AsyncResultStatus)|Gets the status of the asynchronous operation.|
...
An array of `NotificationMessageDetails` objects are returned by the [`NotificationMessages.getAllAsync`](NotificationMessages.html#getAllAsync) method.
...
|`type`| [Office.MailboxEnums.ItemNotificationMessageType](Office.MailboxEnums.html#.ItemNotificationMessageType)|The type of notification message.|
